...
El sistema muestra un dashboard que permite la navegación dentro del aplicativo o la interacción con un chatbot para encontrar las fechas solicitadas por el usuario relacionadas con los factores que pueden influir en la producción de arroz del departamento de saldaña Tolima.
...
|--------------------------------------------------|-----------------------------------------------|
| Usuario                                          | Interesado en la consulta de datos historicos relacionados con factores del clima relacionados con la producción de arroz |
